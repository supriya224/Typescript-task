...
const Header = () => {
  return (
    ...
    <nav className="bg-blue-950 shadow-lg justify-between shadow-indigo-950 border-gray-200">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="w-full md:block md:w-auto" id="navbar-default">
          <ul className="">
            <li>
              <Link to='/home' className="w-4 block py-2 pl-3 pr-4 md:p-0 text-white" aria-current="page" >
                Home
              </Link>
            </li>
